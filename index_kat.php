			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle"><?php echo"$nmmerk"; ?></h3> <br>
						...
						$prod01=mysqli_query($conn,"select * from stock where merk='$c' order by oldtgl DESC limit $from, $max_results");
					...
					<?php
					//$total_results = mysqli_result(mysqli_query($conn,"SELECT COUNT(*) as Num from stock where merk='$c'"),0);
					$jmlresult=mysqli_query($conn,"select COUNT(*) as jmlresult from stock where merk='$c'  ");
					...
					if($page > 1)
						{
						$prev = ($page - 1);
						echo "<li><a href=\"".$_SERVER['PHP_SELF']."?c=$c&page=$prev\">&lt;&lt;Prev</a> </li>";
						}
					...
					for($i = 1; $i <= $total_pages; $i++)
						...
						if(($page) == $i)
							{
							echo "<li class='active'><a href=\"".$_SERVER['PHP_SELF']."?c=$c&page=$i\">$i</a> </li>";
							} 
						else 
							{
							echo "<li><a href=\"".$_SERVER['PHP_SELF']."?c=$c&page=$i\">$i</a> </li>";
							}
						}
					...
					if($page < $total_pages)
						{
						$next = ($page + 1);
						echo "<li><a href=\"".$_SERVER['PHP_SELF']."?c=$c&page=$next\">Next>></a></li>";
						} 
						echo"</ul>
						<p>Terdapat $total_results Produk $nmmerk</p></center> 
					";
